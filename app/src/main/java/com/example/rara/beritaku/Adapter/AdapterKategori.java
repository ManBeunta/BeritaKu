...
public class AdapterKategori extends BaseAdapter {
    ...
    public AdapterKategori(ArrayList<ModelKategori> data, Context c) {
        this.data = data;
        this.c = c;
    }
    @Override
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ModelKategori modelKategori = data.get(position);
        holder.judul.setText(modelKategori.getNamaKat());
        // tampilkan gambar ke dalam image view
        Glide.with(c).load(Server.BASE_IMG + modelKategori.getLogoKat()).
