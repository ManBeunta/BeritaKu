...
public class AdapterBerita extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            holder.tanggal = (TextView) v.findViewById(R.id.TxtTanggal);
        ...
        holder.judul.setText(modelBerita.getJudulBerita());
        holder.tanggal.setText(modelBerita.getTanggal());
        holder.status.setText(modelBerita.getKategori());
        // tampilkan gambar ke dalam image view
        Glide.with(c).load(Server.BASE_IMG + modelBerita.getLogoBerita()).
